...
extension ShakeVellView {
    func setup() {
        let recognizer = UITapGestureRecognizer(target: self, action: #selector(tappedBell))
    ...
    func layout() {
        ...
        NSLayoutConstraint.activate([
            button.leadingAnchor.constraint(equalTo: imageView.trailingAnchor, constant: -9),
